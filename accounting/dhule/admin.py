...
class PatientAdmin(admin.ModelAdmin):
    list_display=('title', 'gender', 'name', 'phone_number', 'alternate_phone_number', 'center', 'mr_uid')
...
class OpdAdmin(admin.ModelAdmin):
    list_display=('patient', 'bill_number', 'date', 'service_name', 'amount', 'remarks', 'opd_date', 'modified_on')
...
class ApprovedPackageAdmin(admin.ModelAdmin):
    list_display=('patient', 'patient_type', 'discount', 'approved_package', 'approval_date', 'proposed_fractions', 'remarks', 'approved_package_date', 'modified_on')

@admin.register(CTScan)
class CTScanAdmin(admin.ModelAdmin):
    list_display=('patient', 'patient_type', 'rt_number', 'amount', 'date', 'conducted_by', 'remarks', 'ctscan_date', 'modified_on')

@admin.register(Radiations)
class RadiationsAdmin(admin.ModelAdmin):
    list_display=('patient', 'patient_type', 'date', 'done_fractions', 'base_value', 'expected_value', 'remarks', 'radiations_date', 'modified_on')

@admin.register(Realization)
class RealizationAdmin(admin.ModelAdmin):
    list_display=('patient', 'patient_type', 'cash', 'amount_received', 'received_by', 'billing_month', 'surplus_percentage', 'deficit_or_surplus_amount', 'deficit_percentage', 'remarks', 'realization_date', 'modified_on')

@admin.register(LockData)
class LockDataAdmin(admin.ModelAdmin):
    list_display=('patient', 'patient_type', 'lock', 'date', 'created_on', 'modified_on')

@admin.register(Discharge)
class DischargeAdmin(admin.ModelAdmin):
    list_display=('patient', 'patient_type', 'date_of_discharge', 'discharge_updated', 'remarks', 'discharge_date', 'modified_on')

@admin.register(Depositor)
class DepositorAdmin(admin.ModelAdmin):
    list_display=('depositor',)

@admin.register(PiggyBank)
class PiggyBankAdmin(admin.ModelAdmin):
    list_display=('depositor', 'date', 'amount', 'created_on', 'modified_on')

@admin.register(Withdrawal)
class WithdrawalAdmin(admin.ModelAdmin):
    list_display=('depositor', 'date', 'particulars', 'amount', 'balance', 'voucher_number', 'image', 'docs', 'upload_date', 'modified_on')