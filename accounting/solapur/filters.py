...
class OPDCashSheetFilters(django_filters.FilterSet):
    patient__name=django_filters.CharFilter(widget=forms.TextInput(attrs={'class':'form-control'}), lookup_expr='icontains', label='Name')
    from_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'from', 'class':'form-control'}), field_name='date', label='From - Date ', lookup_expr='gte')
    to_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'to', 'class':'form-control'}), field_name='date', label='To - Date ', lookup_expr='lte')

class BankDepositsFilters(django_filters.FilterSet):
    mode=django_filters.CharFilter(widget=forms.TextInput(attrs={'class':'form-control'}), lookup_expr='icontains')
    from_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'from', 'class':'form-control'}), field_name='date', label='From - Date ', lookup_expr='gte')
    to_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'to', 'class':'form-control'}), field_name='date', label='To - Date ', lookup_expr='lte')
...
class OngoingFilters(django_filters.FilterSet):
    ...
    from_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'from', 'class':'form-control'}), field_name='ipdreport__package__date_of_admission', label='From - Date of Admission ', lookup_expr='gte')
    to_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'to', 'class':'form-control'}), field_name='ipdreport__package__date_of_admission', label='To - Date of Admission ', lookup_expr='lte')
...
class PatientFilters(django_filters.FilterSet):
    name=django_filters.CharFilter(widget=forms.TextInput(attrs={'class':'form-control'}), lookup_expr='icontains', label='Name')
...
class RepudiatedFilters(django_filters.FilterSet):
    ipdreport__patient__name=django_filters.CharFilter(widget=forms.TextInput(attrs={'class':'form-control'}), lookup_expr='icontains', label='Name')
    from_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'from', 'class':'form-control'}), field_name='ipdreport__realization__billing_month', label='From - Date of Admission ', lookup_expr='gte')
    to_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'to', 'class':'form-control'}), field_name='ipdreport__realization__billing_month', label='To - Date of Admission ', lookup_expr='lte')

class ReclaimedRepudiationFilters(django_filters.FilterSet):
    ipdreport__patient__name=django_filters.CharFilter(widget=forms.TextInput(attrs={'class':'form-control'}), lookup_expr='icontains', label='Name')
    from_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'from', 'class':'form-control'}), field_name='ipdreport__realization__billing_month', label='From - Date of Admission ', lookup_expr='gte')
    to_date=django_filters.DateFilter(widget=forms.DateInput(attrs={'type': 'date', 'id': 'from', 'class':'form-control'}), field_name='ipdreport__realization__billing_month', label='To - Date of Admission ', lookup_expr='lte')
